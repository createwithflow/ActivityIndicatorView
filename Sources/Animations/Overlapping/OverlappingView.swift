...
@IBDesignable
public class OverlappingView: UIView {
    ...
    private func createBTop() {
        ...
        bTop.shapeLayer.strokeColor = UIColor(red: 0.314, green: 0.89, blue: 0.761, alpha: 1).cgColor
    ...
    private func createBTop1() {
        ...
        bTop_1.shapeLayer.strokeColor = UIColor(red: 0.314, green: 0.89, blue: 0.761, alpha: 1).cgColor
    ...
    private func createRBottom() {
        ...
        rBottom.shapeLayer.lineDashPhase = 20.99
    ...
    private func createBBottom() {
        ...
        bBottom.shapeLayer.strokeColor = UIColor(red: 0.314, green: 0.89, blue: 0.761, alpha: 1).cgColor
        ...
        bBottom.shapeLayer.lineDashPhase = 20.99
