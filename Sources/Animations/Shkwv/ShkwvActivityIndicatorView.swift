...
@IBDesignable
class ShkwvActivityIndicatorView: ActivityIndicatorView {
    private lazy var shkwv: ShkwvView = {
        let startView = ShkwvView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return ShkwvTimeline(view: shkwv, duration: 1.5, repeatCount: .greatestFiniteMagnitude)
    }
