...
@IBDesignable
class CompassActivityIndicatorView: ActivityIndicatorView {
    private lazy var compass: CompassView = {
        let startView = CompassView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return CompassTimeline(view: compass, duration: 1, repeatCount: .greatestFiniteMagnitude)
    }
