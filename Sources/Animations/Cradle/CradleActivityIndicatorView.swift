...
@IBDesignable
class CradleActivityIndicatorView: ActivityIndicatorView {
    private lazy var cradle: CradleView = {
        let startView = CradleView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return CradleTimeline(view: cradle, duration: 1.5, repeatCount: .greatestFiniteMagnitude)
    }
