...
@IBDesignable
class StretchAroundActivityIndicatorView: ActivityIndicatorView {
    private lazy var stretchAround: StretchAroundView = {
        let startView = StretchAroundView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return StretchAroundTimeline(view: stretchAround, duration: 2, repeatCount: .greatestFiniteMagnitude)
    }
