...
@IBDesignable
class SplayedActivityIndicatorView: ActivityIndicatorView {
    private lazy var splayed: SplayedView = {
        let startView = SplayedView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return SplayedTimeline(view: splayed, duration: 1.5, repeatCount: .greatestFiniteMagnitude)
    }
