...
@IBDesignable
class HicksActivityIndicatorView: ActivityIndicatorView {
    private lazy var hicks: HicksView = {
        let startView = HicksView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return HicksTimeline(view: hicks, duration: 1.25, repeatCount: .greatestFiniteMagnitude)
    }
