...
@IBDesignable
class FireActivityIndicatorView: ActivityIndicatorView {
    private lazy var fire: FireView = {
        let startView = FireView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return FireTimeline(view: fire, duration: 0.5, repeatCount: .greatestFiniteMagnitude)
    }
