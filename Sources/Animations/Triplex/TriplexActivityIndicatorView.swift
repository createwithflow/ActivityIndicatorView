...
@IBDesignable
class TriplexActivityIndicatorView: ActivityIndicatorView {
    private lazy var triplex: TriplexView = {
        let startView = TriplexView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return TriplexTimeline(view: triplex, duration: 1, repeatCount: .greatestFiniteMagnitude)
    }
