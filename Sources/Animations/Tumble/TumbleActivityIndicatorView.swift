...
@IBDesignable
class TumbleActivityIndicatorView: ActivityIndicatorView {
    private lazy var tumble: TumbleView = {
        let startView = TumbleView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return TumbleTimeline(view: tumble, duration: 3, repeatCount: .greatestFiniteMagnitude)
    }
