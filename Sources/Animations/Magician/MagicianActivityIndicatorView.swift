...
@IBDesignable
class MagicianActivityIndicatorView: ActivityIndicatorView {
    private lazy var magician: MagicianView = {
        let startView = MagicianView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return MagicianTimeline(view: magician, duration: 2.3, repeatCount: .greatestFiniteMagnitude)
    }
