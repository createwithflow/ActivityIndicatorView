...
@IBDesignable
class GriddyActivityIndicatorView: ActivityIndicatorView {
    private lazy var griddy: GriddyView = {
        let startView = GriddyView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return GriddyTimeline(view: griddy, duration: 1.46, repeatCount: .greatestFiniteMagnitude)
    }
