...
@IBDesignable
class SkeuActivityIndicatorView: ActivityIndicatorView {
    private lazy var skeu: SkeuView = {
        let startView = SkeuView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return SkeuTimeline(view: skeu, duration: 2, repeatCount: .greatestFiniteMagnitude)
    }
