...
@IBDesignable
class ReflectActivityIndicatorView: ActivityIndicatorView {
    private lazy var reflect: ReflectView = {
        let startView = ReflectView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return ReflectTimeline(view: reflect, duration: 3, repeatCount: .greatestFiniteMagnitude)
    }
