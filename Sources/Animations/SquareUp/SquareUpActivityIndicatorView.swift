...
@IBDesignable
class SquareUpActivityIndicatorView: ActivityIndicatorView {
    private lazy var squareUp: SquareUpView = {
        let startView = SquareUpView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return SquareUpTimeline(view: squareUp, duration: 3, repeatCount: .greatestFiniteMagnitude)
    }
