...
@IBDesignable
class RainbowActivityIndicatorView: ActivityIndicatorView {
    private lazy var rainbow: RainbowView = {
        let startView = RainbowView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return RainbowTimeline(view: rainbow, duration: 1.77, repeatCount: .greatestFiniteMagnitude)
    }
