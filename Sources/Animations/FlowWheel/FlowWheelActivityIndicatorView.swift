...
@IBDesignable
class FlowWheelActivityIndicatorView: ActivityIndicatorView {
    private lazy var flowWheel: FlowWheelView = {
        let startView = FlowWheelView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return FlowWheelTimeline(view: flowWheel, duration: 2, repeatCount: .greatestFiniteMagnitude)
    }
