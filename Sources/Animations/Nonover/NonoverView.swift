...
@IBDesignable
public class NonoverView: UIView {
    ...
    private func createRTop() {
        ...
        rTop.shapeLayer.lineDashPattern = [6, 28]
        rTop.shapeLayer.lineDashPhase = 5.99
    ...
    private func createBTop() {
        ...
        bTop.shapeLayer.lineDashPattern = [6, 28]
        bTop.shapeLayer.lineDashPhase = 5.99
    ...
    private func createRRight() {
        ...
        rRight.shapeLayer.lineDashPattern = [6, 28]
        rRight.shapeLayer.lineDashPhase = 5.99
    ...
    private func createBTop1() {
        ...
        bTop_1.shapeLayer.strokeColor = UIColor(red: 0, green: 0, blue: 1, alpha: 1).cgColor
        bTop_1.shapeLayer.fillColor = nil
        bTop_1.shapeLayer.lineCap = CAShapeLayerLineCap(rawValue: "round")
        bTop_1.shapeLayer.lineDashPattern = [6, 28]
        bTop_1.shapeLayer.lineDashPhase = 5.99
    ...
    private func createRBottom() {
        ...
        rBottom.shapeLayer.lineDashPattern = [6, 28]
        rBottom.shapeLayer.lineDashPhase = 5.99
    ...
    private func createBBottom() {
        ...
        bBottom.shapeLayer.strokeColor = UIColor(red: 0.455, green: 0.282, blue: 0.988, alpha: 1).cgColor
        bBottom.shapeLayer.fillColor = nil
        bBottom.shapeLayer.lineCap = CAShapeLayerLineCap(rawValue: "round")
        bBottom.shapeLayer.lineDashPattern = [6, 28]
        bBottom.shapeLayer.lineDashPhase = 5.99
    ...
    private func createRLeft() {
        ...
        rLeft.shapeLayer.lineDashPattern = [6, 28]
        rLeft.shapeLayer.lineDashPhase = 5.99
    ...
    private func createBLeft() {
        ...
        bLeft.shapeLayer.strokeColor = UIColor(red: 0.314, green: 0.89, blue: 0.761, alpha: 1).cgColor
        bLeft.shapeLayer.fillColor = nil
        bLeft.shapeLayer.lineCap = CAShapeLayerLineCap(rawValue: "round")
        bLeft.shapeLayer.lineDashPattern = [6, 28]
        bLeft.shapeLayer.lineDashPhase = 5.99
