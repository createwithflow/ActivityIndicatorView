...
@IBDesignable
class RouletteActivityIndicatorView: ActivityIndicatorView {
    private lazy var roulette: RouletteView = {
        let startView = RouletteView(frame: .zero)
    ...
    override var timeline: Timeline? {
        return RouletteTimeline(view: roulette, duration: 2, repeatCount: .greatestFiniteMagnitude)
    }
